---
title: "Claude Code 한국어 답변의 번역투, skill로 깎아내기"
date: 2026-05-17
categories: [dev-tools, ai]
---

Claude Code를 한국어로 쓰다 보면 자꾸 어색한 표현을 씁니다 "행동 규칙이 코드 작성 전체를 **지배**하므로", "정합성이 **높다**", "~에 의해 ~된다" — 한국어 화자가 일상에서 거의 쓰지 않는 영어 직역체입니다.
